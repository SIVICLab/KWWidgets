...
//vtkCxxRevisionMacro(vtkKWScaleWithEntry, "$Revision: 1.20 $");
...
void vtkKWScaleWithEntry::DisplayPopupModeCallback()
{
  ...
  // make sure the slider has the same value as the entry
  this->EntryValueCallback(NULL); 
...
{
  if (this->Entry && this->Entry->GetValue() && *this->Entry->GetValue())
    {
